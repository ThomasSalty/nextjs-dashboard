...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  console.log("state in create-form.tsx: ", state);
	...
	return (
		<form action={formAction}>
            ...
            aria-atomic="true": When set on an element inside an ARIA live region (e.g., something with aria-live="polite" or role="status"):
              Screen readers will read the entire region whenever any part of it changes, not just the changed node.
              That means if even a small piece of text updates, the screen reader re-announces the whole container for context.
            */}
